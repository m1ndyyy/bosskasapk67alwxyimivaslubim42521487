namespace NovelWF
{
    partial class Form10_NE
    {
        ...
        {
            System.ComponentModel.ComponentResourceManager resources = new System.ComponentModel.ComponentResourceManager(typeof(Form10_NE));
            button2 = new Button();
            button1 = new Button();
            ...
            groupBox1.Text = "НЕЙТРАЛЬНАЯ КОНЦОВКА";
            // 
            // pictureBox4
            // 
            ...
            label1.TabIndex = 0;
            label1.Text = "Вы находите убежище. Оно пустое. \r\nТолько старый телевизор бесконечно показывает Shrek Forever After.";
            // 
            // button3
            // 
