...
namespace NovelWF
{
    public partial class Form3 : Form
    {
        ...
        {
            new string[] { "Рассказчик", "Вы обыскиваете окрестности и находите наполовину закопанного робота\nс лицом Навального и телом из деталей Xbox Series X." },
            new string[] { "Рассказчик", "Рядом лежит планшет Samsung Galaxy S42 Ultra с картой памяти." },
            new string[] { "Робо-Навальный", "Здравствуйте! Я Робо-Навальный версии 6.7.\nМой процессор работает на донатах и ненависти к стульям." },
            new string[] { "Игрок", "Ты... функционируешь? После всего этого?" },
            new string[] { "Робо-Навальный", "Да. После апокалипсиса выжили только тараканы, Nokia 3310 и я." }
        };
        ...
        private void ShowDialog()
        {
            ...
            {
                GameManager.CloseAndShow<Form3_2>();
                return;
            }
