...
namespace NovelWF
{
    public partial class Form2 : Form
    {
        ...
        {
            new string[] { "Рассказчик", "Датчик шлема сообщает: кислород — нормальный." },
            new string[] { "Рассказчик", "Воздух пригоден для дыхания. Но стоит ли снимать шлем,\nесли где-то рядом может быть ТунТунСахур?" }
        };
        ...
        private void ShowDialog()
        {
            ...
            {
                GameManager.CloseAndShow<Form2_2>();
                return;
            }
