...
namespace NovelWF
{
    public partial class Form5 : Form
    {
        ...
        {
            new string[] { "Рассказчик", "Вы находите заброшенный супермаркет \"Пятёрочка X Cyberpunk 2077\"." },
            new string[] { "Игрок", "Наконец-то. Если тут есть дошик — человечество еще можно спасти." },
            new string[] { "Рассказчик", "Среди полок лежат консервы, бутылка ПСЫЖа и пачка сухариков \"3 КОРОЧКИ\"." },
            new string[] { "Рассказчик", "Солнце медленно тонет в песке. Где-то вдалеке слышится \"ГОЙДА\"." },
            new string[] { "Рассказчик", "В отделе электроники все еще работает один телевизор." }
        };
        ...
        private void ShowDialog()
        {
            ...
            {
                GameManager.CloseAndShow<Form5_2>();
                return;
            }
