namespace NovelWF
{
    partial class Form6
    {
        ...
        private void InitializeComponent()
        {
            ...
            label1.Name = "label1";
            label1.Size = new Size(531, 19);
            label1.TabIndex = 0;
            label1.Text = "Ночь опускается на пустыню. Освещение магазина начинает мигать как во ФНАФе.";
            // 
            // button3
            // 
            button3.Location = new Point(692, 52);
