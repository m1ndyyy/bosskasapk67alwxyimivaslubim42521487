namespace NovelWF
{
    partial class Form5_2
    {
        ...
        private void InitializeComponent()
        {
            ...
            label4.Font = new Font("Comic Sans MS", 9.75F, FontStyle.Italic, GraphicsUnit.Point, 204);
            label4.Location = new Point(441, 86);
            label4.Name = "label4";
            label4.Size = new Size(124, 19);
            label4.TabIndex = 3;
            label4.Text = "Разбить телевизор";
            // 
            // label3
            // 
            label3.AutoSize = true;
            label3.Font = new Font("Comic Sans MS", 9.75F, FontStyle.Italic, GraphicsUnit.Point, 204);
            label3.Location = new Point(441, 45);
            label3.Name = "label3";
            label3.Size = new Size(158, 19);
            label3.TabIndex = 2;
            label3.Text = "Смотреть документалку";
            // 
            // label2
            // 
            label2.AutoSize = true;
            label2.Font = new Font("Comic Sans MS", 9.75F, FontStyle.Italic, GraphicsUnit.Point, 204);
            label2.Location = new Point(113, 86);
            label2.Name = "label2";
            label2.Size = new Size(113, 19);
            label2.TabIndex = 1;
            label2.Text = "Смотреть Стинта";
            // 
            // label1
            // 
            ...
            label1.TabIndex = 0;
            label1.Text = "Смотреть Skibidi Toilet";
            // 
            // button2
            // 
            ...
            // button3
            // 
            button3.Location = new Point(692, 51);
